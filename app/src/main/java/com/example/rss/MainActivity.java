...
import com.example.rss.ui.musica.ReproductorMusica;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                R.id.nav_home,R.id.nav_rss, R.id.nav_acercade, R.id.nav_contacto,R.id.nav_juegos , R.id.nav_musica, R.id.nav_fotos, R.id.nav_video, R.id.nav_sensor, R.id.nav_mapa)
